...
class APPSBaseDataset(torch.utils.data.Dataset):
    ...
    def initialize(self):
        ...
        for problem_name in tqdm(self.problem_dirs):
            ...
            sols_fname = os.path.join(self.dataroot, problem_name, "solutions.json") if "APPS" in self.dataroot else os.path.join(self.dataroot, problem_name, "solution.json")
            ...
            # print(question_fname, sols_fname)
